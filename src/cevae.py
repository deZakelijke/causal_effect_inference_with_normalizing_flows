...
class CEVAE(Model):
    ...
    def __init__(
        ...
        **_
        ...
        self.encoder = Encoder(x_dims, t_dims, t_dist, t_loss, t_activation,
                               y_dims, y_dist, y_loss, y_activation, z_dims,
                               "Encoder", feature_maps, architecture_type,
                               debug)
        self.decoder = Decoder(x_cat_dims, x_cont_dims, t_dims, t_loss,
                               t_activation, y_dims, y_loss, y_activation,
                               z_dims, category_sizes, "Decoder", feature_maps,
