...
\begin{document}
\begin{tikzpicture}
    \node[draw, minimum width=0.7cm, minimum height=3.5cm, rounded corners, label=$p(\bx)$, fill=black!10!white] (x) at (0.5, 0) {};
    \node[draw, minimum width=0.7cm, minimum height=1cm, rounded corners] (x1) at (2.5, 1) {};
    ...
    \node[draw, minimum width=0.7cm, minimum height=1cm, rounded corners, label={$q(\by|\bt \eq 0, \bx)$}, fill=black!10!white] (qyt0) at (8.0, 1) {};
    ...
    \node[draw, minimum width=0.7cm, minimum height=1cm, rounded corners] (x24) at (9.5, -1) {};
    \node[draw, minimum width=0.7cm, minimum height=1cm, rounded corners, label={$q(\bz | \by,\bt \eq 0, \bx)$}, fill=black!10!white] (qzt0) at (11.0, 1) {};
